		...
		<div class=\"panel\">
			<div class=\"top\">
				<div class=\"left\" style=\"padding-top: 5px;\">
					...
					<h2 class=\"dark\" style=\"margin-top:10px;margin-left:20px;\">{$lang['groups']}</h1>
				</div>
				<div class=\"right\">
					...
					<div class=\"sidemenu\">
						<div class=\"sidemenu\">	
							<ul>
								...
								<ul>
									<a href=\"/admin/settings/groups\"><li class=\"active\">{$lang['groups']}</li></a>
	...
	$content .= "
						<tr>
							...
							<td style=\"width: 100px; text-align: center;\">
								<a href=\"/admin/settings/groups/detail?id={$g['id']}\" title=\"{$lang['manage']}\"><img class=\"link\" src=\"/{$GLOBALS['CONFIG']['SITE']}/images/icons/large/preview.png\" alt=\"{$lang['manage']}\" /></a>
							</td>
						</tr>";
}
	...
	$content .= "
		<div id=\"new\" class=\"floatingdialog\">
			...
			<div class=\"form-small\">		
				<form action=\"/admin/settings/groups/add_action\" method=\"post\" class=\"center\">
					<fieldset>

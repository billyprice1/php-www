		...
		<div class=\"admin\">
			<div class=\"top\">
				<div class=\"left\" style=\"width: 700px;\">
					<img style=\"width: 60px; height: 60px; border-radius: 100px; padding: 5px; border-radius: 3px; text-align: right; float: left; margin-right: 20px;\" src=\"".(file_exists("{$GLOBALS['CONFIG']['SITE']}/images/users/{$user['id']}.png")?"/{$GLOBALS['CONFIG']['SITE']}/images/users/{$user['id']}.png":"/{$GLOBALS['CONFIG']['SITE']}/images/users/user.png")."\" />

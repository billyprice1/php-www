...
<form method="post" action="setup-config.php?step=2">
	...
	<table class="form-table">
		...
		<tr>
			...
			<td><input name="uname" id="uname" type="text" size="25" value="{{[database]}}" /></td>
		...
		<tr>
			...
			<td><input name="dbhost" id="dbhost" type="text" size="25" value="{{[server]}}" /></td>
			<td><?php _e( 'You should be able to get this info from your web host, if <code>localhost</code> does not work.' ); ?></td>
		</tr>
		<tr>
			<th scope="row"><label for="prefix"><?php _e( 'Table Prefix' ); ?></label></th>
			<td><input name="prefix" id="prefix" type="text" size="25" value="{{[random_char]}}_" /></td>
